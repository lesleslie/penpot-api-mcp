...
class PenpotSettings(BaseSettings):
    ...
    # Penpot connection
    base_url: HttpUrl = Field(  # type: ignore[assignment]  # ty: ignore[invalid-assignment]
        default="https://design.penpot.app/api",  # type: ignore[arg-type]  # ty: ignore[invalid-argument-type]
